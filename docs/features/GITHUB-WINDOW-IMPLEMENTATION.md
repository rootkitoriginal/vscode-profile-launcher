...
#### 1.1.2 Repository Manager Window (Main View) - ENHANCED

**Trigger**: Duplo clique no profile card quando já tem GitHub configurado

```text
╔═══════════════════════════════════════════════════════════════════════════════════════════════════════════════╗
║ 📁 rootkitoriginal/vscode-profile-launcher           🔒 Private    ⭐ Star  🔔 Watch  🍴 Fork   [_] [□] [×]     ║
╠═══════════════════════════════════════════════════════════════════════════════════════════════════════════════╣
║                                                                                                               ║
║  ┌─────────────────────────────────────────────────────────────────────────────────────────────────────────┐ ║
║  │ � Overview     📋 Issues (3)     🔀 Pull requests (1)     💾 Commits     🌿 Branches     ⚙️ Settings    │ ║
║  └─────────────────────────────────────────────────────────────────────────────────────────────────────────┘ ║
║                                                                                                               ║
║  ┌─────────────────────────────────────────────────────────────────────────────────────────────────────────┐ ║
║  │ 🌿 master          [�]             � Protected • 256 commits • Updated 2 hours ago by @rootkitoriginal │ ║
║  │ [🔄 Sync with GitHub]  [📂 Open in VSCode]  [🤖 AI Chat]  [⚙️ Repository Settings]                      │ ║
║  └─────────────────────────────────────────────────────────────────────────────────────────────────────────┘ ║
║                                                                                                               ║
║  ┌────────────────────────────────────────────── ABOUT ──────────────────────────────────────────────────┐  ║
║  │                                                                                                         │  ║
║  │  📝 VSCode Profile Launcher with GitHub integration, AI-powered descriptions, and keyboard shortcuts   │  ║
║  │                                                                                                         │  ║
║  │  🏷️ Topics:  electron  typescript  vscode  github-api  ai-integration  profile-manager                │  ║
║  │                                                                                                         │  ║
║  │  � https://github.com/rootkitoriginal/vscode-profile-launcher                                         │  ║
║  │  📜 License: MIT                                                                                        │  ║
║  │  📅 Created: Sep 15, 2024 • Updated: 2 hours ago • Language: TypeScript 78.5%                          │  ║
║  │                                                                                                         │  ║
║  └─────────────────────────────────────────────────────────────────────────────────────────────────────────┘  ║
║                                                                                                               ║
...
║  │                                                                                                         │   ║
║  │  ╭──────────╮  ╭──────────╮  ╭──────────╮  ╭──────────╮  ╭──────────╮  ╭──────────╮  ╭──────────╮   │   ║
║  │  │   ⭐15   │  │   👁️ 3    │  │   🍴 2    │  │  📝 256  │  │   🌿 3    │  │  🏷️ 2    │  │ 📁 145   │   │   ║
║  │  │  Stars   │  │ Watchers │  │  Forks   │  │ Commits  │  │ Branches │  │ Releases │  │  Files   │   │   ║
║  │  ╰──────────╯  ╰──────────╯  ╰──────────╯  ╰──────────╯  ╰──────────╯  ╰──────────╯  ╰──────────╯   │   ║
║  │                                                                                                         │   ║
║  │  � Code:  ████████████████░░░░ 78.5% TypeScript  ███░░░ 12.3% JavaScript  ██░░ 9.2% CSS/HTML         │   ║
║  │                                                                                                         │   ║
║  └─────────────────────────────────────────────────────────────────────────────────────────────────────────┘   ║
║                                                                                                               ║
║  ┌───────────────────────────────────────────── RECENT ACTIVITY ────────────────────────────────────────┐   ║
║  │                                                                                                         │   ║
║  │  � Issues (3 open • 8 closed)                                                        [+ New Issue]    │   ║
║  │  ╭─────────────────────────────────────────────────────────────────────────────────────────────────╮  │   ║
║  │  │                                                                                                   │  │   ║
║  │  │  #13  🪟 GitHub Repository Manager - Janela Separada com AI Integration                         │  │   ║
║  │  │       ┌─────────────────────────────────────────────────────────────────────────────────────┐   │  │   ║
║  │  │       │ 🟢 Open • 🏷️ enhancement, feature, frontend, priority:high                          │   │  │   ║
║  │  │       │ � @rootkitoriginal opened 5 minutes ago • 💬 0 comments                             │   │  │   ║
║  │  │       │                                                                                       │   │  │   ║
║  │  │       │ Implementar janela Electron dedicada para gerenciar repositórios GitHub com        │   │  │   ║
║  │  │       │ interface GitHub-inspired e integração com AI Assistant para issues/PRs.            │   │  │   ║
║  │  │       │                                                                                       │   │  │   ║
║  │  │       │ [💬 Comment] [✏️ Edit] [🤖 Open with AI] [🔗 View on GitHub]                        │   │  │   ║
║  │  │       └─────────────────────────────────────────────────────────────────────────────────────┘   │  │   ║
║  │  │                                                                                                   │  │   ║
║  │  │  #11  🎨 UI/UX Improvements - Custom Menu System & Enhanced GitHub Integration               │  │   ║
║  │  │       ┌─────────────────────────────────────────────────────────────────────────────────────┐   │  │   ║
║  │  │       │ 🔴 Closed • 🏷️ enhancement, feature, frontend                                       │   │  │   ║
║  │  │       │ 👤 @rootkitoriginal closed 10 minutes ago • � 2 comments • ✅ Completed by PR #12  │   │  │   ║
║  │  │       │                                                                                       │   │  │   ║
║  │  │       │ ✅ PR #12 merged: GitHub integration, AI descriptions, keyboard shortcuts, etc.     │   │  │   ║
║  │  │       │ 📊 Metrics: +2,444 lines, 3 new components, 60% reduction in setup clicks           │   │  │   ║
║  │  │       │                                                                                       │   │  │   ║
║  │  │       │ [💬 Comment] [🤖 Open with AI] [🔗 View on GitHub]                                  │   │  │   ║
║  │  │       └─────────────────────────────────────────────────────────────────────────────────────┘   │  │   ║
║  │  │                                                                                                   │  │   ║
║  │  │  #8   📦 App.js Refactoring - 70% Reduction COMPLETE                                          │  │   ║
║  │  │       ┌─────────────────────────────────────────────────────────────────────────────────────┐   │  │   ║
║  │  │       │ 🔴 Closed • 🏷️ refactoring, architecture                                            │   │  │   ║
║  │  │       │ � @copilot closed 3 days ago • 💬 5 comments • ✅ Completed by PR #7               │   │  │   ║
║  │  │       │                                                                                       │   │  │   ║
║  │  │       │ Quebrou app.js monolítico (1399 linhas) em 8 módulos (455 linhas finais)           │   │  │   ║
║  │  │       │ 📊 Result: 67.5% reduction, 5 UI components, centralized state management           │   │  │   ║
║  │  │       │                                                                                       │   │  │   ║
║  │  │       │ [💬 Comment] [🤖 Open with AI] [🔗 View on GitHub]                                  │   │  │   ║
║  │  │       └─────────────────────────────────────────────────────────────────────────────────────┘   │  │   ║
║  │  │                                                                                                   │  │   ║
...
║                                                                                                               ║
║  ┌────────────────────────────────────────────────────────────────────────────────────────────────────────┐  ║
║  │  🔀 Pull Requests (1 open • 12 merged • 0 closed)                                      [+ New PR]      │  ║
║  │  ╭─────────────────────────────────────────────────────────────────────────────────────────────────╮  │  ║
║  │  │                                                                                                   │  │  ║
║  │  │  #12  ✨ feat: Add comprehensive UI/UX improvements                                  🟢 MERGED   │  │  ║
║  │  │       ┌─────────────────────────────────────────────────────────────────────────────────────┐   │  │  ║
║  │  │       │ ✅ Merged by @rootkitoriginal 3 hours ago • merged 1 commit into master from        │   │  │  ║
║  │  │       │ copilot/add-custom-menu-system                                                      │   │  │  ║
║  │  │       │                                                                                       │   │  │  ║
║  │  │       │ 📊 Changes: +2,444 −29 lines • 24 files changed                                     │   │  │  ║
║  │  │       │ ✅ All checks passed: ✓ Build ✓ Tests ✓ Lint                                        │   │  │  ║
║  │  │       │ � 3 conversations • 👍 2 approvals • 🎯 60% of UI/UX improvements complete          │   │  │  ║
║  │  │       │                                                                                       │   │  │  ║
║  │  │       │ Implemented: GitHub integration, AI descriptions, keyboard shortcuts, validation,  │   │  │  ║
║  │  │       │ accessibility improvements                                                           │   │  │  ║
║  │  │       │                                                                                       │   │  │  ║
║  │  │       │ [📝 View Changes] [🤖 AI Review] [🔗 View on GitHub]                                │   │  │  ║
║  │  │       └─────────────────────────────────────────────────────────────────────────────────────┘   │  │  ║
║  │  │                                                                                                   │  │  ║
║  │  ╰─────────────────────────────────────────────────────────────────────────────────────────────────╯  │  ║
║  │                                                                                                         │  ║
...
║  │  ╭─────────────────────────────────────────────────────────────────────────────────────────────────╮  │  ║
║  │  │                                                                                                   │  │  ║
║  │  │  📌 f2ca298  docs: Add comprehensive GitHub window implementation plan            2 hours ago    │  │  ║
║  │  │            👤 rootkitoriginal  🌿 master  💬 1 comment                                          │  │  ║
║  │  │            ┌────────────────────────────────────────────────────────────────┐                   │  │  ║
║  │  │            │ • Added 4 detailed mockups (Navigation, Repository Manager,    │                   │  │  ║
║  │  │            │   AI Assistant, Setup)                                         │                   │  │  ║
║  │  │            │ • 7 AI prompt categories with context-aware prompts            │                   │  │  ║
║  │  │            │ • Architecture diagrams and IPC communication                  │                   │  │  ║
║  │  │            │ • +2,342 lines documentation                                   │                   │  │  ║
║  │  │            └────────────────────────────────────────────────────────────────┘                   │  │  ║
║  │  │                                                                                                   │  │  ║
║  │  │  📌 750a6b4  docs: update issue #8 with completion status                    3 hours ago        │  │  ║
║  │  │            👤 rootkitoriginal  🌿 master                                                        │  │  ║
║  │  │            • Marked issue #8 as completed                                                       │  │  ║
║  │  │            • Added PR #7 merge confirmation                                                     │  │  ║
║  │  │                                                                                                   │  │  ║
║  │  │  📌 6fcaf77  Merge pull request #10 from copilot/documentation                5 hours ago        │  │  ║
║  │  │            👤 rootkitoriginal  🌿 master  ✅ Verified                                           │  │  ║
║  │  │            • Complete documentation suite (200KB+)                                              │  │  ║
║  │  │            • API docs, user guides, technical specs                                             │  │  ║
║  │  │                                                                                                   │  │  ║
║  │  │  📌 b794b5d  fix: resolve ESLint indentation errors                          6 hours ago        │  │  ║
║  │  │            👤 copilot  🌿 copilot/add-custom-menu-system                                       │  │  ║
║  │  │            • Fixed 48 markdown lint errors                                                      │  │  ║
...
║  │  │                                                                                                   │  │  ║
║  │  │    📝 85 commits  •  👤 2 contributors  •  💬 24 conversations  •  📊 +15,234 −3,567 lines       │  │  ║
║  │  │                                                                                                   │  │  ║
║  │  ╰─────────────────────────────────────────────────────────────────────────────────────────────────╯  │  ║
║  └─────────────────────────────────────────────────────────────────────────────────────────────────────────┘  ║
║                                                                                                               ║
...
- **Window Size**: 1200x800px (default) • Min: 900x600px • Max: Unlimited
- **Resizable**: Yes • **Maximizable**: Yes • **Position Memory**: Yes
- **Refresh Rate**: Real-time sync every 30s (configurable)
- **Tabs**: Overview (shown), Issues, Pull Requests, Commits, Branches, Settings
- **Quick Actions**: Sync, Open in VSCode, AI Chat, Settings
- **Search**: Global search bar (top-right) for issues/PRs/commits/code
